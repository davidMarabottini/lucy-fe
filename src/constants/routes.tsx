...
const ROUTE_CONFIGS: readonly AppRouteObject[] = Object.freeze([
  ...
  {path: '/work-activities', Element: WorkActivities, handle: {key: 'WORK_ACTIVITIES', label: 'labels.workActivities', Icon: Briefcase, domain: [AUTH_DOMAINS.PRIVATE], menu: [AVAILABLE_MENUS.USER]}},
  ...
  {path: '/sectors', Element: SectorList, handle: {key: 'SECTORS', label: 'labels.sectors', Icon: Layers, domain: [AUTH_DOMAINS.PRIVATE], menu: [AVAILABLE_MENUS.USER]}},
